...
window.addEventListener("DOMContentLoaded", () => {
 ...
 function displayMovieInfo (movieItems){
    let displayMovie = movieItems.map((info) => {
        ...
        <div class="item-info">
           ...
           <img src=${info.img} class="photo" alt=${info.title} />
           <span class="rating">${info.rating}</span>
           <p class="movie-text">${info.desc}</p>
